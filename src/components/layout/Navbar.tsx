...
const Navbar = ({ isHome = false }: NavbarProps) => {
  ...
  return (
    <nav className={clsx("flex items-center justify-center px-4 md:px-8 py-4 md:py-8 relative border-b border-gray-300", {
      "bg-[#F12E2A]": !isHome,
      ...
      <div className='container flex items-center justify-between relative z-10'>
        ...
        <div className='w-[150px] md:w-[200px] h-[50px] md:h-[62px] relative'>
          <Image src="/images/footer-logo.png" alt="Ferrovit Logo" fill className='object-contain'/>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-8">
          <div className="space-x-6 text-white">
            ...
            <Link href="/shop-directories" className="hover:text-gray-200">Shop Directories</Link>
          </div>
        </div>
      ...
      <div className={clsx(
        ...
        <div className="flex flex-col h-full p-6">
          ...
          <div className="flex flex-col space-y-6 text-white">
            <Link href="/" className="hover:text-gray-200 text-lg">Home</Link>
            <Link href="/about" className="hover:text-gray-200 text-lg">About</Link>
            <Link href="/blogs" className="hover:text-gray-200 text-lg">Blogs</Link>
            <Link href="/shop-directories" className="hover:text-gray-200 text-lg">Shop Directories</Link>
          </div>
        </div>
      </div>
